...
function setMyLightClass(event, desiredClass) {
  ...
  this.getElementById(lightId).className = "desiredClass";
}
...
btn1.addEventListener("click", function(){
  setMyLightGreen.apply(this,btn1);
});
  /*
...
setMyLightClass.apply(this, [event, "light-green"]); //array 
})
...
btn8.addEventListener("click", function (event) {
  setMyLightClass.call(this,event, "light-green"); //string
})
...
setLight10Green = setMyLightGreen.bind(btn10);
...
btn13.addEventListener("click", function(event) {
  let bindFunc = setMyLightClass.prototype.bind(this) ;
  bindFunc(event, "light-green"); //to invoke
})
...
btn14.addEventListener("click", function() {
  setMyLightGreen.prototype.bind(this)();
})
...
btn15.addEventListener("click", setMyLightClass.prototype.bind(btn15, event, "light-green"));
}(window));
